...
const remote = [
  { slug: 'kiln-hall', name: '真实陶窑', description: '真实描述', estimated_duration_minutes: 21, highlights: ['真实重点'], focus: '真实观察方向' },
...
assert.strictEqual(steps[0].reason, '真实描述')
...
assert.ok(/开放展厅目录/.test(routePage.data.tagline), 'route page copy must describe an open-hall directory')
