...
assert.ok(profiledPrompt.indexOf('需要解释含义时写“我的分析：”') >= 0, 'styled prompt should prefer analysis summary wording')
assert.ok(profiledPrompt.indexOf('不要写“说明了什么”') >= 0, 'styled prompt should forbid old explanation heading')
