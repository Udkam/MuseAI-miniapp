...
- 九厅与历史追问者新增统一 `128×128` SVG：九厅只用深棕/陶土双色的大轮廓、粗线或大色块表达陶罐、带单个居中矩形门的房屋、窑火、侧刃绑柄石斧、少女侧影、书本、牡丹和可区分临展框；历史追问者最终使用蓝底白色粗线打开书页与大问号，移除容易误认成刷新的环形箭头。旧 PNG 继续作为 `<image>` 加载失败回退。
